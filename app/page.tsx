              ...
              <div className="relative mt-12 w-full flex flex-col gap-6">
                <h2 className="text-5xl sm:text-6xl text-center lg:text-left bg-white border-4 border-black inline-block self-center lg:self-start px-8 py-2 rotate-1 shadow-[4px_4px_0_#000]">
                  ...
                  <div className="flex flex-col gap-6 w-full mt-4">
                    ...
                    <p className="font-body text-2xl font-bold mt-2 leading-tight ml-4">Write awesome open-source Python code that solves real problems.</p>
                  </div>
                  ...
                  <div className="comic-panel mt-4 bg-[#ff90e8] p-6 rotate-[1deg] w-full text-left relative ml-2 sm:ml-8">
                    ...
                    <p className="font-body text-2xl font-bold mt-2 leading-tight text-black ml-4">Ship it live globally so anyone in the world can run <code className="bg-black text-[#58ff21] px-2 py-1 mx-1 skew-x-12 inline-block">pip install</code> your project.</p>
                  </div>
                  ...
                  <div className="comic-panel mt-4 bg-[#58ff21] p-6 -rotate-[2deg] text-left w-full relative">
                    ...
                    <p className="font-body text-2xl font-bold mt-2 leading-tight ml-4 w-full sm:w-[80%]">We reward you with Venom Coins <span className="inline-block bg-[#58ff21] text-black border-2 border-black rounded-full w-8 h-8 text-center leading-7 font-black mx-1 shadow-[2px_2px_0_#000] rotate-12 relative -top-1">V</span> that you can burn in our shop for real world prizes and hardware!</p>
                  </div>
                </div>
              </div>
            </div>
